...
```text
Eine einfache Wetterstation für ein Lernprojekt. Das System soll Temperatur und Luftfeuchtigkeit mit einem DHT22-Sensor messen und die Werte auf einem kleinen OLED-Display anzeigen welcher an einem externen Halter plaziert ist. 
```
