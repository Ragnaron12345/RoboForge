...
// Generated modules: robot_arm_base_plate, rotating_base_servo_mount, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, sg90_servo_bracket, servo_horn_adapter, servo_horn_adapter, servo_horn_adapter, servo_horn_adapter, arm_link_long, arm_link_long, arm_link_long, arm_link_short, elbow_joint_plate, elbow_joint_plate, gripper_palm, gripper_finger, gripper_finger, controller_tray, servo_power_distribution_plate, battery_tray, standoffs, standoffs, screw_fit_test, potentiometer_panel

// Part 1: robot arm base plate
translate([0, 0, 0]) robot_arm_base_plate(150, 115, 4);

// Part 2: rotating base servo mount
translate([174, 0, 0]) rotating_base_servo_mount();

// Part 3: standard servo u bracket
translate([280, 0, 0]) standard_servo_u_bracket();

// Part 4: standard servo u bracket
translate([362, 0, 0]) standard_servo_u_bracket();

// Part 5: standard servo u bracket
translate([0, 139, 0]) standard_servo_u_bracket();

// Part 6: sg90 servo bracket
translate([82, 139, 0]) sg90_servo_bracket();

// Part 7: servo horn adapter
translate([160, 139, 0]) translate([40,40,0]) servo_horn_adapter();

// Part 8: servo horn adapter
translate([266, 139, 0]) translate([40,40,0]) servo_horn_adapter();

// Part 9: servo horn adapter
translate([0, 245, 0]) translate([40,40,0]) servo_horn_adapter();

// Part 10: servo horn adapter
translate([106, 245, 0]) translate([40,40,0]) servo_horn_adapter();

// Part 11: arm link long
translate([212, 245, 0]) arm_link_long();

// Part 12: arm link long
translate([0, 351, 0]) arm_link_long();

// Part 13: arm link long
translate([148, 351, 0]) arm_link_long();

// Part 14: arm link short
translate([296, 351, 0]) arm_link_short();

// Part 15: elbow joint plate
translate([0, 403, 0]) elbow_joint_plate();

// Part 16: elbow joint plate
translate([92, 403, 0]) elbow_joint_plate();

// Part 17: gripper palm
translate([184, 403, 0]) gripper_palm();

// Part 18: gripper finger
translate([268, 403, 0]) gripper_finger();

// Part 19: gripper finger
translate([0, 483, 0]) gripper_finger();

// Part 20: controller tray
translate([108, 483, 0]) controller_tray("arduino_uno");

// Part 21: servo power distribution plate
translate([222, 483, 0]) servo_power_distribution_plate();

// Part 22: battery tray
translate([336, 483, 0]) battery_tray(72, 42, 12);

// Part 23: standoffs
translate([0, 575, 0]) standoff_set();

// Part 24: standoffs
translate([90, 575, 0]) standoff_set();

// Part 25: screw fit test
translate([180, 575, 0]) screw_fit_test();

// Part 26: potentiometer panel
translate([280, 575, 0]) potentiometer_panel();
