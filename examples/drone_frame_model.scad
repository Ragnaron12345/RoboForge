...
// Controller: esp32
// Generated modules: x_frame_plate, motor_pod, motor_pod, motor_pod, motor_pod, prop_guard_segment, prop_guard_segment, prop_guard_segment, prop_guard_segment, controller_tray, battery_strap_plate, standoffs, screw_fit_test, base_plate

// Part 1: x frame plate
translate([0, 0, 0]) x_frame_plate(130, 4);

// Part 2: motor pod
translate([156, 0, 0]) motor_pod();

// Part 3: motor pod
translate([230, 0, 0]) motor_pod();

// Part 4: motor pod
translate([304, 0, 0]) motor_pod();

// Part 5: motor pod
translate([378, 0, 0]) motor_pod();

// Part 6: prop guard segment
translate([0, 156, 0]) translate([36,36,0]) prop_guard_segment();

// Part 7: prop guard segment
translate([102, 156, 0]) translate([36,36,0]) prop_guard_segment();

// Part 8: prop guard segment
translate([204, 156, 0]) translate([36,36,0]) prop_guard_segment();

// Part 9: prop guard segment
translate([306, 156, 0]) translate([36,36,0]) prop_guard_segment();

// Part 10: controller tray
translate([0, 258, 0]) controller_tray("esp32");

// Part 11: battery strap plate
translate([114, 258, 0]) battery_strap_plate();

// Part 12: standoffs
translate([224, 258, 0]) standoff_set();

// Part 13: screw fit test
translate([314, 258, 0]) screw_fit_test();

// Part 14: base plate
translate([0, 332, 0]) base_plate(140, 140, 4);
