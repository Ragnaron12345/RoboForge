...
// Platform: sensor_box
// Controller: esp32
// Generated modules: bottom_shell, lid, controller_tray, battery_tray, display_bezel, small_sensor_clip, small_sensor_clip, small_sensor_clip, weather_louver, cable_clip_set, standoffs, screw_fit_test

// Part 1: bottom shell
translate([0, 0, 0]) sensor_box_bottom(120, 90, 28);

// Part 2: lid
translate([144, 0, 0]) top_cover(120, 90, 3);

// Part 3: controller tray
translate([288, 0, 0]) controller_tray("esp32");

// Part 4: battery tray
translate([0, 114, 0]) battery_tray(72, 42, 12);

// Part 5: display bezel
translate([108, 114, 0]) display_bezel();

// Part 6: small sensor clip
translate([208, 114, 0]) small_sensor_clip();

// Part 7: small sensor clip
translate([272, 114, 0]) small_sensor_clip();

// Part 8: small sensor clip
translate([336, 114, 0]) small_sensor_clip();

// Part 9: weather louver
translate([0, 192, 0]) weather_louver();

// Part 10: cable clip set
translate([108, 192, 0]) cable_clip_set();

// Part 11: standoffs
translate([206, 192, 0]) standoff_set();

// Part 12: screw fit test
translate([296, 192, 0]) screw_fit_test();
