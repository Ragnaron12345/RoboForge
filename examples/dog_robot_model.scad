...
// Generated modules: legged_body_plate, top_cover, controller_tray, battery_tray, servo_power_distribution_plate, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, standard_servo_u_bracket, leg_link_long, leg_link_long, leg_link_long, leg_link_long, leg_link_short, leg_link_short, leg_link_short, leg_link_short, foot_pad, foot_pad, foot_pad, foot_pad, standoffs, standoffs, screw_fit_test

// Part 1: legged body plate
translate([0, 0, 0]) legged_body_plate(135, 95, 4);

// Part 2: top cover
translate([159, 0, 0]) top_cover(115, 75, 3);

// Part 3: controller tray
translate([298, 0, 0]) controller_tray("arduino_uno");

// Part 4: battery tray
translate([0, 119, 0]) battery_tray(72, 42, 12);

// Part 5: servo power distribution plate
translate([108, 119, 0]) servo_power_distribution_plate();

// Part 6: standard servo u bracket
translate([222, 119, 0]) standard_servo_u_bracket();

// Part 7: standard servo u bracket
translate([304, 119, 0]) standard_servo_u_bracket();

// Part 8: standard servo u bracket
translate([0, 197, 0]) standard_servo_u_bracket();

// Part 9: standard servo u bracket
translate([82, 197, 0]) standard_servo_u_bracket();

// Part 10: standard servo u bracket
translate([164, 197, 0]) standard_servo_u_bracket();

// Part 11: standard servo u bracket
translate([246, 197, 0]) standard_servo_u_bracket();

// Part 12: standard servo u bracket
translate([328, 197, 0]) standard_servo_u_bracket();

// Part 13: standard servo u bracket
translate([0, 273, 0]) standard_servo_u_bracket();

// Part 14: standard servo u bracket
translate([82, 273, 0]) standard_servo_u_bracket();

// Part 15: standard servo u bracket
translate([164, 273, 0]) standard_servo_u_bracket();

// Part 16: standard servo u bracket
translate([246, 273, 0]) standard_servo_u_bracket();

// Part 17: standard servo u bracket
translate([328, 273, 0]) standard_servo_u_bracket();

// Part 18: leg link long
translate([0, 349, 0]) leg_link_long();

// Part 19: leg link long
translate([148, 349, 0]) leg_link_long();

// Part 20: leg link long
translate([296, 349, 0]) leg_link_long();

// Part 21: leg link long
translate([0, 401, 0]) leg_link_long();

// Part 22: leg link short
translate([148, 401, 0]) leg_link_short();

// Part 23: leg link short
translate([254, 401, 0]) leg_link_short();

// Part 24: leg link short
translate([0, 453, 0]) leg_link_short();

// Part 25: leg link short
translate([106, 453, 0]) leg_link_short();

// Part 26: foot pad
translate([212, 453, 0]) foot_pad();

// Part 27: foot pad
translate([284, 453, 0]) foot_pad();

// Part 28: foot pad
translate([356, 453, 0]) foot_pad();

// Part 29: foot pad
translate([0, 509, 0]) foot_pad();

// Part 30: standoffs
translate([72, 509, 0]) standoff_set();

// Part 31: standoffs
translate([162, 509, 0]) standoff_set();

// Part 32: screw fit test
translate([252, 509, 0]) screw_fit_test();
